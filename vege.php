...
if (isset($_POST['ADD'])) {
  ...
  $sqll=mysqli_query($db,"delete from vege where ID='$id'");
  if ($sqll) {
    ...
    $sql="INSERT INTO vege(Photo,Description,Nutrients,Conditionn) VALUES('$Photo','$Description','$Nutrients','$Conditionn')";
  ...
  $id=$_GET['id'];
$res=mysqli_query($db,"delete from vege where ID='$id'");
if($res){
 echo "<script type='text/javascript'>alert('Data deleted succussfully');
  window.location='vege.php';</script>";
}
else{
...
<div id="content">
  <table width="100%" border="1" >
                          <th colspan="5" style="line-height:2px;"><h2>Vegetables</h2></th>
    ...
    <tr>
      ...
      echo "<td width='20%'> <p>".$row['Conditionn']."</p> </td>";
       echo "<td> 
      <button id='bt' onclick='return edit($var)'><a href='edit2.php?ID=$var'>EDIT</a></button>
...
<div id="form1">
    <form  method="POST" action="" enctype="multipart/form-data">
      <table align="center" border="1px" style="width: 99%; line-height: 45px;">
        <tr>
          <th colspan="8" style="line-height:2px;"><h2>Vegetables</h2></th>
        </tr>
        <t>
