...
<form  method="POST"  action="fruits.php" enctype="multipart/form-data" >
      <table align="center" border="1px" style="width: 100%; line-height: 30px;">
        ...
        <input style="display: none;" type="text" name="update" value="<?php echo $row['ID'];?>" required></td>      
          ...
          <td style="width: 25%;"><textarea  name="Nutrients" cols="40" rows="10"  required><?php echo $row['Nutrients'];?></textarea> </td>
