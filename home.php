...
<button type="submit" name="button"><a href="index.php">Logout</a> </button>        
<div class="main">
  <ul>
<li><a href="home.php" >HOME</a></li>
<li><a href="meals1.php">MEALS</a></li>
<li><a href="diagnosis1.php" >DIAGNOSIS</a></li>
...
<nav class="navA">
    ...
    <ol>
   <li><a href="fruits1.php">Fruits</a></li>
    <li><a href="vege1.php">Vegetables</a></li>
    <li><a href="leaf1.php">Leafy Vegetables</a></li>
    <li><a href="beve1.php">Beverages</a></li>
    <li><a href="flesh1.php">Flesh Foods</a></li>
    </ol>
</nav>
